      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
        ...
        <div className="xl:col-span-8 min-w-0">
          ...
          <ChartCard
            ...
            subtitle="Monthly reimbursement growth and claim risk activity"
          >
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
              ...
              <div className="flex flex-wrap items-center gap-5">
                ...
                <div className="flex items-center gap-2">
                  <span className="w-7 h-[3px] rounded-full bg-blue-600" />
                ...
                <div className="flex items-center gap-2">
                  <span className="w-7 h-[3px] rounded-full bg-red-500" />
                  <span className="text-[10px] font-bold text-slate-600">
                    Risk Score
                  </span>
                  <span className="text-[9px] text-slate-400">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-4">
              ...
              <div className="rounded-lg bg-blue-50 border border-blue-100 px-3 py-2.5">
                ...
                <p className="text-sm font-extrabold text-blue-700 mt-1">
                  ${monthlyTrend[monthlyTrend.length - 1].reimbursement}K
                </p>
              </div>
              ...
              <div className="rounded-lg bg-red-50 border border-red-100 px-3 py-2.5">
                ...
                <p className="text-sm font-extrabold text-red-700 mt-1">
                  {monthlyTrend[monthlyTrend.length - 1].risk}%
                </p>
              </div>
        ...
        <div className="xl:col-span-4 min-w-0">
          ...
          >
            ...
            {/*
             * Wrapper is position:relative with a FIXED pixel height
             * so the absolutely-positioned center label always has
             * a stable box to center within, regardless of how
             * ResponsiveContainer resizes the underlying SVG.
             */}
            <div className="relative w-full" style={{ height: 220 }}>
              ...
              {/*
               * Center label overlay — plain HTML/CSS, NOT an SVG
               * <text> node. This is what keeps it perfectly centered
               * in the donut hole at any container width, since it's
               * centered with flexbox against the wrapper div rather
               * than positioned with hardcoded SVG coordinates.
               *
               * top: -4% nudges it to match the Pie's cy="48%"
               * (slightly above true center, to leave room for the
