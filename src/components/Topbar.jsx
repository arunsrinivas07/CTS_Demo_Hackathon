...
<div className="relative" ref={notificationRef}>
  <button
    ...
    className="relative p-2.5 rounded-xl border-2 border-slate-200 hover:bg-slate-50 hover:border-brand-blue text-slate-600 transition-all"
  >
        ...
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-500 mt-1">
              Claim CLM-904812 requires immediate investigation.
            </p>
      ...
      <div className="px-4 py-3 hover:bg-slate-50 transition-colors">
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-500 mt-1">
              Unusual billing activity detected for provider PRV51003.
            </p>
            <p className="text-[9px] text-slate-400 mt-1">
              25 minutes ago
            </p>
